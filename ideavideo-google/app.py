...
# Carpetas configurables por variable de entorno (en Cloud Run se usan bajo /tmp, escribible).
OUT = Path(os.getenv("OUTPUT_DIR") or (BASE / "output")); OUT.mkdir(parents=True, exist_ok=True)
WORK = Path(os.getenv("WORK_DIR") or (BASE / "work")); WORK.mkdir(parents=True, exist_ok=True)
